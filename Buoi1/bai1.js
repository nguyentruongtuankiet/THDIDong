...
console.log("Đây là phiên bản 1");
console.log("BMI của Mark với data 1: " + bmiMark11);
console.log("BMI của John với data  1: " + bmiJohn11);
console.log("Với data 1 thì Mark có BMI cao hơn John là: " + markHigherBMI1);
console.log("BMI của Mark với data 2: " + bmiMark21);
console.log("BMI của John với data 2: " + bmiJohn21);
console.log("Với data 2 thì Mark có BMI cao hơn John là: " + markHigherBMI2);
